...
Both cores pass their testbenches under Icarus Verilog:

| Core | Result |
|------|--------|
| `rv32i_single_cycle` | ALL PASS |
| `rv32i_pipeline`     | ALL PASS |

Written against the SystemVerilog LRM. Not yet re-synthesised in Vivado since
the rewrite — next on the list.
